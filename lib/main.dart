...
class _AlignmentPageState extends State<AlignmentPage> {
  ...
  @override
  Widget build(BuildContext context) {
    // Show completion screen for Side 2
    if (_currentSide == 2 && _currentStep == AlignmentStep.finalized) {
      return Scaffold(
        body: Container(
      ...
      child: SingleChildScrollView(
        child: Column(
          ...
          children: [
            ...
            if (_currentStep == AlignmentStep.finalized && _currentSide == 2)
              ElevatedButton.icon(
